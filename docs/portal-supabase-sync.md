...
- Current source-data checks were performed against a non-production test fixture. Customer names, emails and record identifiers are intentionally omitted from this repository.
...
Synthetic fixture data was used to verify client isolation, admin scope and lead ownership. The repository intentionally does not retain customer names, contact emails, Airtable record IDs or a cleanup manifest for those fixtures.
